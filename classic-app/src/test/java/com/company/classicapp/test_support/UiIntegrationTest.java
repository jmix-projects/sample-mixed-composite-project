package com.company.classicapp.test_support;

import com.company.classicapp.ClassicAppApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.classicapp.screen")
@ContextConfiguration(classes = {ClassicAppApplication.class, UiTestAssistConfiguration.class})
